...
- **Microservices**
  - [Microservices](https://github.com/sunilsoni/interview-notes/blob/main/micro-services/micro-services.md)
    ...
    * [How to slowly move users from older version of application to newer version?](uction)
    * [How will you monitor fleet of microservices in production?](Test)
    * [How will you troubleshoot a failed API request that is spread across multiple services?](Test)
    * [What are different layers of a single microservice?](Test)
    * [Test](Test)
    * [Test](Test)
    * [Test](Test)
    * [Test](Test)
