...
- **Angular interview questions and answers**
  - [Angular](https://github.com/sunilsoni/interview-notes/blob/main/angular/Angular.md)
    ...
    * [JIT vs AOT compilation](https)
    * [Advantages of AOT](https)
    * [What are the ways to control AOT compilation?](https)
    * [How to optimize loading large data in angular?](https)
    * [How an Angular application gets started or loaded?](https)
    * [JIT](https)
