...
- **Angular interview questions and answers**
  - [Single-page application(SPA) vs. Multiple-page application(MPA)](https)
    - [Single-page application(SPA)](https)
    - [Pros of the Single-Page Application](https)
    - [Cons of the Single-Page Application](https)
    - [Multiple-page application(MPA)](https)
    - [Pros of the Multiple-Page Application](https)
    - [Cons of the multiple-page application](https)
