...
- **API Gateway**
  ...
  - [What is difference between using a Circuit Breaker and a naive approach where we try/catch a remote method call and protect for failures?](https)
  - [Circuit Breaker](https)
  - [Circuit Breaker](https)
  ...
  - [When not to use Hystrix fallback on a particular microservice?](https)
  - [ignore certain exceptions in Hystrix fallback execution](https)
  - [Request Collapsing feature in Hystrix](https)
  - [Test](https)
  - [Test](https)
  - [Test](https)
- **Kafka**
