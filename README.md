...
- **Spring**
  - [Spring](https://github.com/sunilsoni/interview-notes/blob/main/spring/spring.md#spring)
    ...
    * [Spring Bean Scopes](https://)
    * [What happens when we inject a prototype scope bean in a singleton scope bean?](https:)
    * [How to inject a prototype scope bean in a singleton scope bean?](https://)
